...
const CounterOffer = () => (
      <div>
            <div>
                  ...
                  <p className="smalltxt" style={{ color: "sienna" }}> <em>The following article was published in
              ...
              fired, laid off, etc). </em></p>
                  <br />
                  <p className="smalltxt"><b>Counteroffer Acceptance: Road to Career Ruin</b></p>

                  <p id="dclaim"><em>(Reprinted from the Wall Street Journal and written by Paul Hawkinson.
            Paul has been in the recruiting business for more than 20 years) </em></p>
            ...
            in its proper perspective.</p><br />
                  ...
                  <p className="smalltxt"><em>"This couldn't be happening at a worse time."
              <br />
              ...
              <br />
                        ...
                        "Maybe I can keep him on until I find a suitable replacement." </em> </p>
