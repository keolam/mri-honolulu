...
<div>
        <div>
            <div id="pic">
                <img src={ Image.howWeWork } alt="ocean" style={{width: '100%'}}></img>
            </div>
            <h1>How We Work</h1>

            <p className="smalltxt">Sales Consultants & Management Recruiters of Honolulu is dedicated to helping you as a hiring authority find the right talent. Not only do we find a qualify the best talents for you to interview and consider, we also offer a few tips and guidelines based on our years of experience in the executive and sales search industry to help you in your decision making process.</p>

            <h3>How Your Company Can Benefit</h3>
            ...
            <h3>Leveraging Our Geographic Advantage</h3>
            <p className="smalltxt">
