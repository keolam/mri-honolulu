...
const InterviewGuide = () => (
    ...
    <>
        ...
        <br />
        <h3 data-aos="fade-in" data-aos-delay="300">Questions</h3>
        <div className="smalltxt" data-aos="fade-in" data-aos-delay="300">
        ...
        <h3 data-aos="fade-in" data-aos-delay="300">The Interview</h3>
        <div className="smalltxt" data-aos="fade-in" data-aos-delay="300">
        ...
        <br />
        <h3 data-aos="fade-in" data-aos-delay="300">Analyzing</h3>
        <div className="smalltxt" data-aos="fade-in" data-aos-delay="300">
        ...
        <h2 id="following" data-aos="fade-in" data-aos-delay="300">The following are questions that may help you in the interview process.</h2>

        <section className="int-quest" data-aos="fade-in" data-aos-delay="400">
            <h2>I. ATTITUDE</h2>
        ...
        <section className="int-quest" data-aos="fade-in" data-aos-delay="400">
            ...
            <div className="question">
                ...
                <div className="smalltxt">
                    ...
                    <p>5) What obstacles are most likely to trip you up? </p>
                </div>
            </div>
        </section>
        <section className="int-quest" data-aos="fade-in" data-aos-delay="400">
            <h2>III. INITIATIVE</h2>
            <div className="qualifier">
                <h3>If you want to know:</h3>
                <div className="smalltxt">
        ...
        <section className="int-quest" data-aos="fade-in" data-aos-delay="400">
            ...
            <div className="question">
                ...
                <div className="smalltxt">
                    ...
                    <p>6) How do you handle job pressures? Explain. </p>
                </div>
            </div>
        </section>
        <section className="int-quest" data-aos="fade-in" data-aos-delay="400">
