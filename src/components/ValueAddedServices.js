...
const ValueAddedServices = () => (    
    <div>
        <div>
            ...
            <p className="smalltxt" data-aos="fade-up" data-aos-delay="300">SelecSys™ is a computer-based, pre-employment testing and screening system that provides a quick, accurate means of determining a candidate's personality traits and potential "fit" with your company.
